...
const explorerCategories = [category("colors", "Colors", "palette", "coral"), category("shapes", "Shapes", "shapes", "blue"), category("animals", "Animals", "paw", "green"), category("numbers", "Numbers", "numbers", "yellow"), category("alphabet", "ABC", "letters", "purple")];
...
export const explorer: AgeGroupDefinition = {
  ...
  activities: [
    ...
    ...buildLearningCatalog("2-3", explorerCategories, 1),
  ],
};
